...
public class SimpleMenuFactory {
    ...
    public MenuComponent createPancakeHouseMenu() {
    ...
    public MenuComponent createDinerMenu() {
    ...
    public MenuComponent createCoffeeMenu() {
    ...
    public MenuComponent createDessertMenu() {
